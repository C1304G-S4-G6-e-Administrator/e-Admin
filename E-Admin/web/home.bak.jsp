...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="webContent/StyleHome/layout/styles/layout.css" rel="stylesheet" type="text/css"/>
        <script src="webContent/StyleHome/layout/scripts/jquery.min.js" type="text/javascript"></script>     
        <script src="webContent/StyleHome/layout/scripts/jquery.cycle.min.js" type="text/javascript"></script>
    ...
    <body id="top">
            ...
            <div id="header">
                <div id="topnav">
                    <ul>
                        ...
                        <li><a href="/E-Admin/User">User</a></li>
                        <li><a href="pages/style-demo.html">Style Demo</a></li>
                        <li class="active"><a href="index.html">Homepage</a></li>
                    </ul>
                </div>
                <div id="logo">
                    <h1><a href="index.html"><strong>L</strong>ab <strong>H</strong>ome</a></h1>
        ...
        <div class="wrapper col5">
            <div id="copyright">
                <p class="fl_left">Copyright &copy; C1304G </p>
