...
public class TechUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db.updateData("update Reports set report_status = " +status + ",report_message = '" + message+"'  where report_id =" + id);
            
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/Repor");
            dispatch.forward(request, response);
        } catch (Exception ex) {
            Logger.getLogger(TechUpdate.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
